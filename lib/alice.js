    ...
    workflowStatuses(method, params) {
        function getId(res, params){
            ...
            res.forEach(function(e){
                if(e.name.toLowerCase() === params.status.toLowerCase()) id = e.id; 
            });
            return id;
        }
        if (method === 'getId') {
            return this.action('workflowStatuses','getAll', params).then(function(statuses){
                return getId(statuses, params);
            });   
        } else return this.action('workflowStatuses', method, params);
    }
}
